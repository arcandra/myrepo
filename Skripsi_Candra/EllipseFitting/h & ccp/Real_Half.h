...
#ifndef _REAL_HALF_H_
#define _REAL_HALF_H_

#include <basicfb.h>
#include <forte_real.h>

class FORTE_Real_Half: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_Real_Half)
...
public:
  FORTE_Real_Half(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_Real_Half(){};
