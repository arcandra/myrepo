...
#ifndef _MATRIXINVERSE_H_
#define _MATRIXINVERSE_H_

#include <basicfb.h>
#include <forte_real.h>

class FORTE_MatrixInverse: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_MatrixInverse)
...
public:
  FORTE_MatrixInverse(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_MatrixInverse(){};
