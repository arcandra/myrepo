...
#ifndef _ARRAYMULCUMULATIVE_H_
#define _ARRAYMULCUMULATIVE_H_
...
class FORTE_ArrayMulCumulative: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_ArrayMulCumulative)
...
public:
  FORTE_ArrayMulCumulative(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_ArrayMulCumulative(){};
