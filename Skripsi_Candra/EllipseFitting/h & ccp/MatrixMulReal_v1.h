...
#ifndef _MATRIXMULREAL_V1_H_
#define _MATRIXMULREAL_V1_H_

#include <basicfb.h>
#include <forte_real.h>

class FORTE_MatrixMulReal_v1: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_MatrixMulReal_v1)
...
private:
  ...
  static const SFBInterfaceSpec scm_stFBInterfaceSpec;
   ...
   FORTE_BASIC_FB_DATA_ARRAY(2, 6, 2, 0, 0);
...
public:
  FORTE_MatrixMulReal_v1(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_MatrixMulReal_v1(){};
